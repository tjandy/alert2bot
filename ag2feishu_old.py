...
# 飞书机器人链接
feishu_boot_url = "https://open.feishu.cn/open-apis/bot/v2/hook/17214edc-b4c4-4dec-9a1b-92e33136ad89"

# 日志模块
logger = logging.getLogger()
logger.setLevel(logging.DEBUG)
fileHandler = logging.FileHandler('td.log', mode='w', encoding='UTF-8')
...
# 启动 nohup waitress-serve --port=23333 feishubot:app > alertmanager_wechatrobot.log &
