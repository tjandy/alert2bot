...
fileHandler = logging.FileHandler('wechatbot.log', mode='w', encoding='UTF-8')
...
app = falcon.API()
wechatbot = wechatbot()
app.add_route('/wechatbot', wechatbot)

# pip install requests falcon waitress
# 启动 nohup waitress-serve --port=23333 wechatbot:app > alertmanager_wechatrobot.log &
